...
void make_sphere_mesh()
{
    ...
    vertex_t *vertices = (vertex_t *) glMapBufferARB(GL_ARRAY_BUFFER_ARB, GL_WRITE_ONLY_ARB);
    ...
    uint16_t *indices = (uint16_t *) glMapBufferARB(GL_ELEMENT_ARRAY_BUFFER_ARB, GL_WRITE_ONLY_ARB);
...
void render_sphere(float rotation)
{
    ...
    glRotatef(rotation*-0.13f, 0, 1, 0);
